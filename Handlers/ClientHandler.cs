...
namespace OTILib.Handlers
{
    ...
    {
        private readonly StackTrace stackTrace = new StackTrace(new StackFrame(true));
        ...
        public ConnState ConnState { get; private set; }
        ...
        public void ChangeConnState(ConnState state)
        {
            ConnState = state;
        }
    }
